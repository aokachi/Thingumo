...
$('.to').on('click', function (e) {
  e.preventDefault();
  $('html,body').stop().animate({ scrollTop: $('.be-answer-block-inner').offset().top - 50 }, 800);
});
